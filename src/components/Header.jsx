    ...
    return (
        <header>
            ...
            <div className='flex items-center bg-amazon_blue p-1 flex-grow py-2'>
                ...
                {/*serachbar*/}
                <div className='hidden items-center h-10 rounded-md sm:flex flex-grow cursor-pointer bg-yellow-400 hover:bg-yellow-500'>
                ...
                <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap">
                    ...
                    <div className='relative link flex items-center' onClick={()=>router.push('/checkout')}>
                        <span className='absolute top-0 right-0 md:right-10 w-4 h-4 bg-yellow-400 text-center rounded-full text-black font-bold'>{items.length}</span>
